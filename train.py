...
"""
    ...
    if trainer.global_rank == 0 and args.print_param_shape > 0:   # 检查是否为主节点并且打印参数形状的条件
    ...
    if "deepspeed" in args.strategy:  # 检查是否使用 DeepSpeed, 用于分布式训练
